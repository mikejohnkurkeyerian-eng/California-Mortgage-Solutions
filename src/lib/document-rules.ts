...
import type { DocumentType, EmploymentStatus, IncomeType, LoanApplication } from "../types/shared";
...
const propertyDocuments: DocumentRequirement[] = [
    {
        ...
        required: true,
        applicableConditions: (app: LoanApplication) => app.loanPurpose === "Purchase",
    ...
    },
    {
        ...
        required: false,
        applicableConditions: (app: LoanApplication) => app.property.propertyType === "Condo" || app.property.propertyType === "Townhouse",
