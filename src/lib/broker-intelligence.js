export class BrokerIntelligenceService {
     ...
     */
    static analyzeDocument(text, type) {
        const insights = [];
        ...
        if (type === 'TAX_RETURN') {
            ...
            insights.push(...this.analyzePayStub(lowerText));
        }
        else if (type === 'FORM_1099') {
            insights.push(...this.analyze1099(lowerText));
        }
        else if (type === 'BANK_STATEMENT') {
            insights.push(...this.analyzeBankStatement(lowerText));
        }
    ...
    // ==========================================
    static analyzeBankStatement(text) {
        const insights = [];
        // 1. NSF/Overdrafts
    ...
    static analyzeAssetStatement(text) {
        const insights = [];
    ...
    // ==========================================
    static analyzeDivorceDecree(text) {
        const insights = [];
    ...
    static analyzeBankruptcyDischarge(text) {
        const insights = [];
    ...
    static analyzeTitleCommitment(text) {
        const insights = [];
    ...
    // ==========================================
    static analyzeLoanEstimate(text) {
        const insights = [];
        // 1. Intent to Proceed
    ...
    static analyzeClosingDisclosure(text) {
        const insights = [];
