...
export class MismoGenerator {
    static generate(loan: LoanApplication): string {
        // Simplified MISMO 3.4 Generation
        // In a real production system, this would be much more comprehensive and use an XML builder library.
                ...
                <DEAL>
                    ...
                    <COLLATERALS>
                        <COLLATERAL>
                            <SUBJECT_PROPERTY>
                                ...
                                <PROPERTY_DETAIL>
                                    <PropertyEstimatedValueAmount>${loan.property.purchasePrice}</PropertyEstimatedValueAmount>
                    ...
                    <LOANS>
                        <LOAN LoanRoleType="SubjectLoan">
                            <LOAN_DETAIL>
                                <BaseLoanAmount>${loan.property.loanAmount}</BaseLoanAmount>
                                <InterestRatePercent>${loan.interestRate}</InterestRatePercent>
                                <LoanAmortizationPeriodCount>${loan.loanTerm}</LoanAmortizationPeriodCount>
                            ...
                            <ROLES>
                                <ROLE RoleType="Borrower">
                                    <BORROWER>
                                        ...
                                        <EMPLOYMENT>
                                            <EMPLOYMENT_DETAIL>
                                                <EmploymentMonthlyIncomeAmount>${loan.employment.monthlyIncome}</EmploymentMonthlyIncomeAmount>
